/*
    ...
    Date:      5 June 2021 7:35 am
    Project 2: Blackjack Game
    Version:   v.4 (Begin to add bubble sort, selection sort, linear search,
                    vectors, parallel array)
 */
...
int main(int argc, char** argv){
    ...
    int    nShuff,   //Number of card shuffles
           ...
           toChs;    //Player chosen with BJ at end of the game for a sticker
    ...
    if((answer == 'y') || (answer == 'Y'))
    {
        ...
        for(int x = 0; x < SIZE; x++)
        {
            ...
            else if(choices[x] == 'h'||choices[x] == 'H')
            {
                ...
                {   
                    ...
                    {
                        //Add dealers fourth card to hand
                        sum2 = cdOne + cdTwo + cdTres + cdFour;
                        ptReslt(sum1 [x], sum2, bets, x);
                        cout << "-----------------------" << endl;
                    }
        ...
        //Linear search to get a sticker
        for(int x = 0; x < SIZE; x++)
        {
            if(linSrch(sum1, toChs)){
                cout << "Player " << x + 1 << " you get a free sticker for a "
