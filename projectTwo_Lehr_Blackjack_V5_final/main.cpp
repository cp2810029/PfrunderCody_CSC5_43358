...
int calcD3C(int&, int);
int calcD4C(int&, int);
void ptReslt(int, int, vector<int> &, int);
...
void ptReslt(int sum1, int sum2, vector<int> &bets, int k){
    cout << "Player " << k + 1 <<": \n";
...
bool linSrch(int sum1[], int toChs){
    for(int i = 0; i < SIZE; i++){
